  ...
  if(isset($_GET['theme']))
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <ul class="list-inline"><li><a href="#"><?php echo $coms[$i]->dateC; ?></a></li><li> <button type="button" class="btn btn-default btn-sm">
          J'aime <span class="glyphicon glyphicon-thumbs-up"></span></button>
         <span class="badge"><?php echo $coms[$i]->nbLike ;?></span> </li><li>
